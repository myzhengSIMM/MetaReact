...
class SmilesEnumerator(object):
    ...
    def randomize_smiles(self, smiles, random_state=None):
        """Perform a randomization of a SMILES string, must be RDKit sanitizable"""
        # if random_state is None:
        #     # Use a hash of the SMILES string to create a consistent seed
        #     seed = int(hashlib.md5(smiles.encode('utf-8')).hexdigest(), 16) % (2**32)
        # else:
        #     seed = random_state
        ...
        np.random.shuffle(ans)  # Shuffle atoms
