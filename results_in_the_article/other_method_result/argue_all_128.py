...
def augment_smiles(smiles, sme, augmentation_factor):
    ...
    for _ in range(augmentation_factor):
        randomized_smiles = sme.randomize_smiles(smiles)
...
# 指定输入和输出文件
input_file_path = "/home/wangyitian/opennmt-model/output/test_set/esmiles/smiles_128_input.csv"
output_file_path = "origin_128_argu10.csv"
